...
player1 = Personnage(pygame.K_q, pygame.K_d,"Asset/image/personnage/skin de base.png")
player2 = Personnage(pygame.K_LEFT, pygame.K_RIGHT, "Asset/image/personnage/skin alternatif.png")
grille = Grille()
